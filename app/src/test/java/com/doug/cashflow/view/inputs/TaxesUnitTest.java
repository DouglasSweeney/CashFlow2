...
public class TaxesUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        taxes = InputLab.getTaxes();
    }

    @After
    public void tearDown() throws Exception {
        mockTaxesFederalTaxRateView.setText("0.0");
        mockTaxesStateTaxRateView.setText("0.0");
    }
    ...
    @Test
    public void getFederalTaxRate() throws Exception {

        Float rate = taxes.getFederalTaxRate();

        assertThat(2.0f, is(rate));
    }

    @Test
    public void getStateTaxRate() throws Exception {

        Float rate = taxes.getStateTaxRate();

        assertThat(2.0f, is(rate));
    }

    @Test
    public void setFederalTaxRate() throws Exception {

        taxes.setFederalTaxRate("4.0");
    ...
    @Test
    public void setStateTaxRate() throws Exception {

        taxes.setStateTaxRate("4.0");

        Float amount = taxes.getStateTaxRate();
