...
public class SavingsUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockSavingsBalanceView.getText()).thenReturn("2.0");
        when(mockSavingsGrowthRateView.getText()).thenReturn("2.0");

        InputLab.getInstance(mockContext, activity.getSupportFragmentManager(), mockParent);
        savings = InputLab.getSavings();
    }

    @After
    public void tearDown() throws Exception {
        mockSavingsBalanceView.setText("0");
        mockSavingsGrowthRateView.setText("0.0");
    }
    ...
    public void getBalance() throws Exception {
        ...
        Float balance = savings.getBalance();
    ...
    public void getGrowthRate() throws Exception {
        ...
        Float growthRate = savings.getGrowthRate();
