...
public class FederalAndStateAmountsUnitTest {

    private FederalAndStateAmounts federalAndStateAmounts;
...
*/
        ...
        values.setFederalTaxes(100.0);
        values.setStateTaxes(105.0);
        ...
        federalAndStateAmounts = new FederalAndStateAmounts(mockContext, arrayList, R.string.output_header_taxes);
    }

    @After
    public void tearDown() throws Exception {
        federalAndStateAmounts = null;
    }

    @Test
    public void preCondition() throws Exception {

        assertNotNull(federalAndStateAmounts);
    }

    @Test
    public void getView() throws Exception {

        federalAndStateAmounts.createView(mockContext, arrayList, "Title");

        View view = federalAndStateAmounts.getView();
    ...
    public void getDataStringNotNull() throws Exception {
        String str = federalAndStateAmounts.getData(arrayList);
