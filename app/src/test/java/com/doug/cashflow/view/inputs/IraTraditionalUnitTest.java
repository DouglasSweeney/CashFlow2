...
public class IraTraditionalUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockIraTraditionalBalanceView.getText()).thenReturn("2.0");
        when(mockIraTraditionalGrowthRateView.getText()).thenReturn("2.0");
        when(mockIraTraditionalAnnualContributionsView.getText()).thenReturn("2.0");
        when(mockIraTraditionalStartWithdrawalsAgeView.getText()).thenReturn("2");
        when(mockIraTraditionalNumberOfWithdrawalsView.getText()).thenReturn("2");

        InputLab.getInstance(mockContext, activity.getSupportFragmentManager(), mockParent);
        iraTraditional = InputLab.getTraditionalIra();
    }

    @After
    public void tearDown() throws Exception {
        mockIraTraditionalBalanceView.setText("0.0");
        mockIraTraditionalGrowthRateView.setText("0.0");
        mockIraTraditionalAnnualContributionsView.setText("0.0");
        mockIraTraditionalStartWithdrawalsAgeView.setText("0");
        mockIraTraditionalNumberOfWithdrawalsView.setText("0");
    }
    ...
    public void getBalance() throws Exception {
        ...
        Float balance = iraTraditional.getBalance();
    ...
    public void getGrowthRate() throws Exception {
        ...
        Float growthRate = iraTraditional.getGrowthRate();
    ...
    public void getContributions() throws Exception {
        ...
        Float contribution = iraTraditional.getContributions();
    ...
    public void getStartWithdrawalsAge() throws Exception {
        ...
        Integer age = iraTraditional.getStartWithdrawalsAge();
    ...
    public void getNumberOfWithdrawals() throws Exception {
        ...
        Integer number = iraTraditional.getNumberOfWithdrawals();
    ...
    public void setGrowthRate() throws Exception {
        ...
        iraTraditional.setGrowthRate("4.0");
    ...
    public void setContributions() throws Exception {
        ...
        iraTraditional.setContributions("4.0");
    ...
    public void setStartWithdrawalsAge() throws Exception {
        ...
        iraTraditional.setStartWithdrawalsAge("4");
    ...
    public void setNumberOfWithdrawals() throws Exception {
        ...
        iraTraditional.setNumberOfWithdrawals("4");
    ...
    public void getView() throws Exception {
        ...
        View view = iraTraditional.getView();
