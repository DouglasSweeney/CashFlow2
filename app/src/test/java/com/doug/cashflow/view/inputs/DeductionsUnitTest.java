...
public class DeductionsUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockDeductionsDeductionsView.getText()).thenReturn("2.0");

        InputLab.getInstance(mockContext, activity.getSupportFragmentManager(), mockParent);
        deductions = InputLab.getDeductions();
    }

    @After
    public void tearDown() throws Exception {
        mockDeductionsDeductionsView.setText("0.0");
    }
    ...
    public void getDeduction() throws Exception {
        ...
        Float deduction = deductions.getDeductions();

        assertThat(2.0f, is(deduction));
    }

    @Test
    public void setDeduction() throws Exception {

        deductions.setDeductions("4.0");
