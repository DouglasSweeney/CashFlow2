...
@PrepareForTest({LoginLab.class, Context.class, MockContext.class, LayoutInflater.class, View.class, TextView.class, String.class})
...
*/
        ...
        when (String.format(anyString(), anyString(), anyString(), anyString(), anyString(), anyString(), anyString())).
                thenReturn("%-5.5s%-4.4s%-6.6s%-8.8s%-9.9s%-4.4s\n");

        when(mockContext.getString(R.string.output_header_year)).thenReturn("Year");
        when(mockContext.getString(R.string.output_header_age)).thenReturn("Age");
        when(mockContext.getString(R.string.output_header_begin)).thenReturn("Begin");
        when(mockContext.getString(R.string.output_header_deposit)).thenReturn("Deposit");
        when(mockContext.getString(R.string.output_header_withdraw)).thenReturn("Withdraw");
        when(mockContext.getString(R.string.output_header_end)).thenReturn("End");
        when(mockContext.getString(anyInt())).thenReturn("AnyInt");

        String title = "Title";
        when(mockContext.getString(R.id.title)).thenReturn(title);
        ...
        account = new Account(mockContext, arrayList, R.string.title_login);
    }
    ...
    public void getView() throws Exception {
        ...
        account.createView(mockContext, arrayList, "Title");

        View view = account.getView();
    ...
    public void getDataStringNotNull() throws Exception {
        String str = account.getData(arrayList);
    ...
    public void getDataEndOfListAge() throws Exception {
        ...
        assertThat(true, is(str.contains("60")));
    }
    ...
    public void getDataEndOfEndingBalance() throws Exception {
        ...
        assertThat(true, is(str.contains("111")));
    }
}
