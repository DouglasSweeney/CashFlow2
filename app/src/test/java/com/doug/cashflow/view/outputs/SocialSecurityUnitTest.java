...
public class SocialSecurityUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        title = "Title";
        when(mockContext.getString(R.string.output_header_social_security)).thenReturn(title);
        ...
        socialSecurity = new SocialSecurity(mockContext, arrayList);
    }
    ...
    public void getName() throws Exception {
        ...
        assertThat(title, is(socialSecurity.getName()));
    }
}
