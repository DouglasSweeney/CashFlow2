...
public class IraRothUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockIraRothBalanceView.getText()).thenReturn("2.0");
        when(mockIraRothGrowthRateView.getText()).thenReturn("2.0");
        when(mockIraRothAnnualContributionsView.getText()).thenReturn("2.0");
        when(mockIraRothStartWithdrawalsAgeView.getText()).thenReturn("2");
        when(mockIraRothNumberOfWithdrawalsView.getText()).thenReturn("2");

        InputLab.getInstance(mockContext, activity.getSupportFragmentManager(), mockParent);
        iraRoth = InputLab.getRothIra();
    }

    @After
    public void tearDown() throws Exception {
        mockIraRothBalanceView.setText("0.0");
        mockIraRothGrowthRateView.setText("0.0");
        mockIraRothAnnualContributionsView.setText("0.0");
        mockIraRothStartWithdrawalsAgeView.setText("0");
        mockIraRothNumberOfWithdrawalsView.setText("0");
    }

    @Test
    public void preCondition() throws Exception {

        assertNotNull(iraRoth);
    }

    @Test
    public void getBalance() throws Exception {

        Float balance = iraRoth.getBalance();
    ...
    public void getGrowthRate() throws Exception {
        ...
        Float growthRate = iraRoth.getGrowthRate();
    ...
    public void getContributions() throws Exception {
        ...
        Float contribution = iraRoth.getContributions();
    ...
    public void getStartWithdrawalsAge() throws Exception {
        ...
        Integer age = iraRoth.getStartWithdrawalsAge();
    ...
    public void getNumberOfWithdrawals() throws Exception {
        ...
        Integer number = iraRoth.getNumberOfWithdrawals();
    ...
    public void setStartWithdrawalsAge() throws Exception {
        ...
        iraRoth.setStartWithdrawalsAge("4");
    ...
    public void setNumberOfWithdrawals() throws Exception {
        ...
        iraRoth.setNumberOfWithdrawals("4");
