...
public class PersonalUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockPersonalRetirementAgeView.getText()).thenReturn("2");
        when(mockPersonalLifeExpectancyAgeView.getText()).thenReturn("2");
        when(mockPersonalInflationView.getText()).thenReturn("2.0");

        InputLab.getInstance(mockContext, activity.getSupportFragmentManager(), mockParent);
        personal = InputLab.getPersonal();
    }

    @After
    public void tearDown() throws Exception {
        mockPersonalRetirementAgeView.setText("0");
        mockPersonalLifeExpectancyAgeView.setText("0");
        mockPersonalInflationView.setText("0.0");
    }
