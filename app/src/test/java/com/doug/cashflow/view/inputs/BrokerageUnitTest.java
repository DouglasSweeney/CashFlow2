...
public class BrokerageUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockBrokerageBalanceView.getText()).thenReturn("2.0");
        when(mockBrokerageGrowthRateView.getText()).thenReturn("2.0");

        InputLab.getInstance(mockContext, activity.getSupportFragmentManager(), mockParent);
        brokerage = InputLab.getBrokerage();
    }

    @After
    public void tearDown() throws Exception {
        mockBrokerageBalanceView.setText("0.0");
        mockBrokerageGrowthRateView.setText("0.0");
    }
    ...
    public void getBalance() throws Exception {
        ...
        Float balance = brokerage.getBalance();
    ...
    public void getGrowthRate() throws Exception {
        ...
        Float growthRate = brokerage.getGrowthRate();
