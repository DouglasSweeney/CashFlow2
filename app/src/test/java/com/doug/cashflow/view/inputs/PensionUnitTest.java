...
public class PensionUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockPensionStartingAgeView.getText()).thenReturn("2");
        when(mockPensionMonthlyAmountView.getText()).thenReturn("2.0");
        ...
        pension = InputLab.getPension();
    }

    @After
    public void tearDown() throws Exception {
        mockPensionStartingAgeView.setText("0");
        mockPensionMonthlyAmountView.setText("0.0");
        mockPensionInflationAdjustCheckBoxView.setText("true");
    }
    ...
    @Test
    public void getStartingAge() throws Exception {

        Integer age = pension.getStartingAge();

        assertThat(2, is(age));
    }

    @Test
    public void getMonthlyAmount() throws Exception {

        Float amount = pension.getMonthlyAmount();

        assertThat(2.0f, is(amount));
    }

    @Test
    public void getInflationAdjusted() throws Exception {

        boolean adjusted = pension.getInflationAdjusted();

        assertThat(false, is(adjusted));
    }

    @Test
    public void setStartingAge() throws Exception {

        pension.setStartingAge("4");
    ...
    @Test
    public void setMonthlyAmount() throws Exception {

        pension.setMonthlyAmount("4.0");
    ...
    @Test
    public void setInflationAdjusted() throws Exception {

        pension.setInflationAdjusted(true);
