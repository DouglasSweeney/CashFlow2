...
public class PensionUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        title = "Title";
        when(mockContext.getString(R.string.output_header_pension)).thenReturn(title);
        ...
        pension = new Pension(mockContext, arrayList);
    }
    ...
    public void getName() throws Exception {
        ...
        assertThat(title, is(pension.getName()));
    }
}
