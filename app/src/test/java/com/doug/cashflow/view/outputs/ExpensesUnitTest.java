...
public class ExpensesUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        title = "Title";
        when(mockContext.getString(R.string.output_header_expenses)).thenReturn(title);
        ...
        expenses = new Expenses(mockContext, arrayList);
    }
    ...
    public void getName() throws Exception {
        ...
        assertThat(title, is(expenses.getName()));
    }
}
