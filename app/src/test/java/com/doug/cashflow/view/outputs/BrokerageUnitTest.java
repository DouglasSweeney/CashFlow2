...
public class BrokerageUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockView.findViewById(R.id.text_area)).thenReturn(mockTextView);
         ...
         title = "Title";
        when(mockContext.getString(R.string.output_header_brokerage)).thenReturn(title);
        ...
        brokerage = new Brokerage(mockContext, arrayList);
    }
    ...
    public void getName() throws Exception {
        ...
        assertThat(title, is(brokerage.getName()));
    }
}
