...
public class SalaryUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockSalarySalaryView.getText()).thenReturn("2");
        when(mockSalaryMeritIncreaseView.getText()).thenReturn("2.0");

        InputLab.getInstance(mockContext, activity.getSupportFragmentManager(), mockParent);
        salary = InputLab.getSalary();
    }

    @After
    public void tearDown() throws Exception {
        mockSalarySalaryView.setText("0");
        mockSalaryMeritIncreaseView.setText("0.0");
    }
    ...
    public void getSalary() throws Exception {
        ...
        Float sal = salary.getSalary();

        assertThat(2.0f, is(sal));
    }

    @Test
    public void getMeritIncrease() throws Exception {

        Float amount = salary.getMeritIncrease();
    ...
    @Test
    public void setMeritIncrease() throws Exception {

        salary.setMeritIncrease("4.0");
