...
public class IraTraditionalUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        title = "Title";
        when(mockContext.getString(R.string.output_header_ira_traditional)).thenReturn(title);
        ...
        iraTraditional = new IraTraditional(mockContext, arrayList);
    }
    ...
    public void getName() throws Exception {
        ...
        assertThat(title, is(iraTraditional.getName()));
    }
}
