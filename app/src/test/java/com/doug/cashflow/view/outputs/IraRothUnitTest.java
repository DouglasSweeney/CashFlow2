...
public class IraRothUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        title = "Title";
        when(mockContext.getString(R.string.output_header_ira_roth)).thenReturn(title);
        ...
        iraRoth = new IraRoth(mockContext, arrayList);
    }
    ...
    public void getName() throws Exception {
        ...
        assertThat(title, is(iraRoth.getName()));
    }
}
