...
public class CashBalanceUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockCashBalanceBalanceView.getText()).thenReturn("2.0");
        when(mockCashBalanceGrowthRateView.getText()).thenReturn("2.0");
        when(mockCashBalanceAnnualContributionsView.getText()).thenReturn("2.0");
        when(mockCashBalanceStartWithdrawalsAgeView.getText()).thenReturn("2");
        when(mockCashBalanceNumberOfWithdrawalsView.getText()).thenReturn("2");

        InputLab.getInstance(mockContext, activity.getSupportFragmentManager(), mockParent);
        cashBalance = InputLab.getCashBalance();
    }

    @After
    public void tearDown() throws Exception {
        mockCashBalanceBalanceView.setText("0.0");
        mockCashBalanceGrowthRateView.setText("0.0");
        mockCashBalanceAnnualContributionsView.setText("0.0");
        mockCashBalanceStartWithdrawalsAgeView.setText("0");
        mockCashBalanceNumberOfWithdrawalsView.setText("0");
    }
    ...
    public void getBalance() throws Exception {
        ...
        Float balance = cashBalance.getBalance();
    ...
    public void getGrowthRate() throws Exception {
        ...
        Float growthRate = cashBalance.getGrowthRate();
    ...
    public void getContributions() throws Exception {
        ...
        Float contribution = cashBalance.getContributions();
    ...
    public void getStartWithdrawalsAge() throws Exception {
        ...
        Integer age = cashBalance.getStartWithdrawalsAge();
    ...
    public void getNumberOfWithdrawals() throws Exception {
        ...
        Integer number = cashBalance.getNumberOfWithdrawals();
    ...
    public void setContributions() throws Exception {
        ...
        cashBalance.setContributions("4.0");
    ...
    public void setStartWithdrawalsAge() throws Exception {
        ...
        cashBalance.setStartWithdrawalsAge("4");
    ...
    public void setNumberOfWithdrawals() throws Exception {
        ...
        cashBalance.setNumberOfWithdrawals("4");
