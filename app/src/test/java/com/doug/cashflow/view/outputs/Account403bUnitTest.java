...
public class Account403bUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        title = "Title";
        when(mockContext.getString(R.string.output_header_403b)).thenReturn(title);
        ...
        account403b = new Account403b(mockContext, arrayList);
    }
    ...
    public void getName() throws Exception {
        ...
        assertThat(title, is(account403b.getName()));
    }
}
