...
public class DeductionsUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        title = "Title";
        when(mockContext.getString(R.string.output_header_deductions)).thenReturn(title);
        ...
        deductions = new Deductions(mockContext, arrayList);
    }
    ...
    public void getName() throws Exception {
        ...
        assertThat(title, is(deductions.getName()));
    }
}
