...
//        when(mockActivity.getResources()).thenReturn(mockResources);
        ...
        title = "Title";
//        when(mockResources.getString(R.string.output_header_401k)).thenReturn(title);
        when(mockContext.getString(R.string.output_header_401k)).thenReturn(title);
        ...
        account401k = new Account401k(mockContext, arrayList);
    }
    ...
    public void getName() throws Exception {
        ...
        assertThat(title, is(account401k.getName()));
    }
}
