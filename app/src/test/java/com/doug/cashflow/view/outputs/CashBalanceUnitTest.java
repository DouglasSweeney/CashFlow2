...
public class CashBalanceUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockView.findViewById(R.id.text_area)).thenReturn(mockTextView);
         ...
         title = "Title";
        when(mockContext.getString(R.string.output_header_cash_balance)).thenReturn(title);
        ...
        cashBalance = new CashBalance(mockContext, arrayList);
    }
    ...
    public void getName() throws Exception {
        ...
        assertThat(title, is(cashBalance.getName()));
    }
}
