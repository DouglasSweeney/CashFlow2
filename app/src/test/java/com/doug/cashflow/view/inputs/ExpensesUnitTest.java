...
public class ExpensesUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockDeductionsDeductionsView.getText()).thenReturn("0.0");

        when(mockExpensesExpenseView.getText()).thenReturn("2.0");

        InputLab.getInstance(mockContext, activity.getSupportFragmentManager(), mockParent);
        expenses = InputLab.getExpenses();
    }

    @After
    public void tearDown() throws Exception {
        mockExpensesExpenseView.setText("0.0");
    }
    ...
    public void getExpense() throws Exception {
        ...
        Float expense = expenses.getAnnualExpenses();

        assertThat(2.0f, is(expense));
    }

    @Test
    public void setExpense() throws Exception {

        expenses.setExpenses("4.0");
