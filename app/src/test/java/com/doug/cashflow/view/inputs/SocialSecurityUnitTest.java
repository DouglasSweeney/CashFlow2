...
public class SocialSecurityUnitTest {
    ...
    public void setUp() throws Exception {
        ...
        when(mockSocialSecurityStartingAgeView.getText()).thenReturn("2");
        when(mockSocialSecurityMonthlyAmountView.getText()).thenReturn("2.0");

        InputLab.getInstance(mockContext, activity.getSupportFragmentManager(), mockParent);
        socialSecurity = InputLab.getSocialSecurity();
    }

    @After
    public void tearDown() throws Exception {
        mockSocialSecurityStartingAgeView.setText("0");
        mockSocialSecurityMonthlyAmountView.setText("0.0");
    }
    @Test
    ...
    public void getStartingAge() throws Exception {
        ...
        Integer age = socialSecurity.getStartingAge();
    ...
    public void getMonthlyAmount() throws Exception {
        ...
        Float amount = socialSecurity.getMonthlyAmount();
    ...
    public void setStartingAge() throws Exception {
        ...
        socialSecurity.setStartingAge("4");
    ...
    public void setMonthlyAmount() throws Exception {
        ...
        socialSecurity.setMonthlyAmount("4.0");
    ...
    public void getView() throws Exception {
        ...
        View view = socialSecurity.getView();
