...
import com.doug.cashflow.controller.InputFragment;
...
public class Account401K {
    ...
    private static final String TAG = "Account401K (Input)";
    ...
    public Account401K(int pageIndex, Context context, FragmentManager fragmentManager, ViewGroup parent) {
    ...
    public String getName(Context context) {
        return context.getString(R.string.input_header_401k);
    }

    public View createView(final Context context, @SuppressWarnings("unused") final FragmentManager fragmentManager, ViewGroup parent) {
        TextView titleView;

        v = (LayoutInflater.from(context)).inflate(R.layout.input_account_401k, parent, false);

        // Setup the title (readonly)
        titleView = (TextView) v.findViewById(R.id.title);
        titleView.setText(getName(context));

        Field textField1 = new Field();
        mBalanceField = textField1.createField(v, R.id.account_401k_balance,
        ...
        mGrowthRateField = textField2.createField(v, R.id.account_401k_growth_rate,
        ...
        mAnnualContributionsField = textField3.createField(v, R.id.account_401k_contributions,
                context.getString(R.string.field_contributions),
                getName(context), Util.SET_DEFAULT.SET_DEFAULT_0_DOT_00, context);

        Field textField4 = new Field();
        mStartWithdrawalsAgeField = textField4.createField(v, R.id.account_401k_start_withdrawals_age,
        ...
        mNumberOfWithdrawalsField = textField5.createField(v, R.id.account_401k_number_of_withdrawals,
