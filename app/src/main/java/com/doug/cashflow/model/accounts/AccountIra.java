...
public class AccountIra extends Account implements Accounts {
     ...
     * @param double annualcontribution  The contribution to this account
     ...
     * @return void
     */
    public AccountIra(double balance, double growthRate, double annualContribution, int currentAge, 
    		           int currentYear, int retirementAge, int deathAge, int startWithdrawalsAge, int numberOfWithdrawals) {
...
/*	
    public static void main(String[] args) {
		...
		AccountIraTraditional accountIra = new AccountIraTraditional(354000.0, 0.04, 0.0, 57, 2016, 62, 95, 59, 5);
